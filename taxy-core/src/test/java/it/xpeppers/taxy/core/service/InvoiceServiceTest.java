...
public class InvoiceServiceTest {
	...
	public void init() {
		...
		// SHOPPING BASKETS 1
		shoppingBaskets1.add(new Product(new BigDecimal("12.49"), new BigDecimal("0"), ProductCategory.BOOK, false));
		shoppingBaskets1.add(new Product(new BigDecimal("14.99"), new BigDecimal("0"), ProductCategory.MUSIC, false));
		shoppingBaskets1.add(new Product(new BigDecimal("0.85"), new BigDecimal("0"), ProductCategory.BOOK, false));

		// SHOPPING BASKETS 2
		shoppingBaskets2.add(new Product(new BigDecimal("10.00"), new BigDecimal("0"), ProductCategory.FOOD, true));
		shoppingBaskets2.add(new Product(new BigDecimal("47.50"), new BigDecimal("0"), ProductCategory.PERFUME, true));

		// SHOPPING BASKETS 3
		shoppingBaskets3.add(new Product(new BigDecimal("27.99"), new BigDecimal("0"), ProductCategory.PERFUME, true));
		shoppingBaskets3.add(new Product(new BigDecimal("18.99"), new BigDecimal("0"), ProductCategory.PERFUME, false));
		shoppingBaskets3.add(new Product(new BigDecimal("9.75"), new BigDecimal("0"), ProductCategory.MEDICAL, false));
		shoppingBaskets3.add(new Product(new BigDecimal("11.25"), new BigDecimal("0"), ProductCategory.FOOD, true));
	...
	public void calculateProductBasicSalesTaxTest() {
		...
		Assert.assertEquals(new BigDecimal("10.00"),
			invoiceService.calculateProductBasicSalesTax(new BigDecimal("100.00")));
	}

	@Test
	public void calculateProductImportSalesTaxTest() {
		// Imported sales tax fixed at 5%
		Assert.assertEquals(new BigDecimal("5.00"),
			invoiceService.calculateProductImportSalesTax(new BigDecimal("100.00")));
	}
}
