...
/**
 * Class <code>GlobalExceptionHandler.java</code> is
 *
...
public class JsonMappingExceptionHandler implements ExceptionMapper<JsonMappingException> {
	...
	private static final Logger LOG = LoggerFactory.getLogger(JsonMappingExceptionHandler.class);

	@Override
	public Response toResponse(JsonMappingException jsonMappingException) {

		LOG.info("UnrecognizedPropertyExceptionHandler :: {}", jsonMappingException.getMessage());
